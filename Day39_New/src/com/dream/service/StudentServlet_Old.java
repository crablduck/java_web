...
public class StudentServlet_Old extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if("showlist".equals(action)){//展示学生列表功能
			...
			int pageSize = 5;//每一页的数据条数
			int totalPage = stuBiz.getTotalPage(pageSize);//总页数
			...
			ArrayList<StudentDto> dtolist = stuBiz.getStuList(currentPage,pageSize);
